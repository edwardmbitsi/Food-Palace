// active navbar link  
 ...
 const food=[  
   ...
   ,{id:24,  
     name:"MANDAZI",  
     img:"https://i0.wp.com/jayne-rain.com/wp-content/uploads/2018/07/mandazi-4.jpg?resize=640%2C960&ssl=1",  
     price:4,  
     cateogary:"BREAKFAST",  
   }  
   ,  
   {id:25,  
     name:"KAIMATI",  
     img:"https://allkenyanrecipescom.files.wordpress.com/2015/04/kaimati1.jpg?w=496&h=747",  
     price:4,  
     cateogary:"BREAKFAST",  
   }  
   ,{id:26,  
     name:"COFFEE",  
     img:"https://static.toiimg.com/photo/90908667/90908667.jpg?v=3",  
     price:4,  
     cateogary:"BREAKFAST",  
   }  
   ,{id:27,  
     name:"DOUGHNUTS",  
     img:"https://images.unsplash.com/photo-1618411640018-972400a01458?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8ZG91Z2hudXR8ZW58MHx8MHx8&w=1000&q=80",  
     price:3,  
     cateogary:"BREAKFAST",  
   }  
   ,{id:28,  
